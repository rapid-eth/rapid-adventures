  ...
  return (
    <Atom.Flex alignCenter between sx={showcase.container}>
      ...
      <Atom.Flex column sx={showcase.left}>
        ...
        <Atom.Paragraph>
          Manage your collections of collectibles.
        </Atom.Paragraph>
      </Atom.Flex>
      <Atom.Flex sx={showcase.right}>
        <Atom.Box>
          <Atom.Button sx={showcase.actions}>Manage Gear</Atom.Button>
          <Atom.Button white sx={showcase.actions}>
            Unlock Collectible Sets
          </Atom.Button>
        </Atom.Box>
      </Atom.Flex>
    </Atom.Flex>
  ...
  return (
    <Atom.Flex sx={{flex: 1}}>
      <Atom.Flex sx={styles.mainLeft}>
        <Collections column sx={{p: 4, flex: 1}} />
      </Atom.Flex>
...
const CollectionsRoles = props => {
  return (
    <Atom.Box>
      <Atom.Heading xl>Collections</Atom.Heading>
      <Atom.Paragraph sm>
      ...
      <Atom.Heading xl>Collectibles</Atom.Heading>
      <Atom.Paragraph sm>
        Aliquam sodales diam non diam placerat, at vulputate magna gravida. Sed
        sed posuere turpis. Phasellus et purus et nisl suscipit lobortis. Sed
        iaculis ut est ac sagittis.
      </Atom.Paragraph>
      <Atom.Heading xl>Trading</Atom.Heading>
      <Atom.Paragraph sm>
        Aliquam sodales diam non diam placerat, at vulputate magna gravida. Sed
        sed posuere turpis. Phasellus et purus et nisl suscipit lobortis. Sed
        iaculis ut est ac sagittis.
