...
var effects = (callUseEffect, state, dispatch) => {
        ...
        (function() {
          var _ref = _asyncToGenerator(function*() {
            try {
              ...
              var newContracts = (0, _utilities.generateNewContracts)(
                state.contracts,
                wallet
              );
              dispatch({
   ...
   * @description WALLET_SIGN_MESSAGE_REQUEST
   */
            ...
            try {
              ...
              switch (messageRequest.type) {
                case 'WALLET_SIGN_TYPED_MESSAGE_REQUEST':
                  signature = yield state.provider.injected.send(
                    'eth_signTypedData',
                ...
                default:
                  signature = yield state.wallet.signMessage(
        ...
        (function() {
          var _ref3 = _asyncToGenerator(function*() {
            ...
            try {
              ...
              if (wallet) {
                contract = new _ethers.ethers.ContractFactory(
