...
var Provider = (_ref) => {
  ...
  var [web3, setWeb3] = (0, _react.useState)();
  var [dispatched, setDispatched] = (0, _react.useState)(props.dispatched);
  ...
  (0, _react.useEffect)(() => {
    if (!dispatched) {
      var fm = new _fortmatic.default(key); // const web3Instance = new ethers.providers.Web3Provider(fm.getProvider());

      var web3Instance = new Web3(fm.getProvider());
