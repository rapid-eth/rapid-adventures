...
var _slicedToArray2 = _interopRequireDefault(
	require('/Users/admin/Documents/GitHub/opensource/3box-extensions/node_modules/babel-preset-react-app/node_modules/@babel/runtime/helpers/esm/slicedToArray')
);
...
var useSpaceReadyEffect = function useSpaceReadyEffect(box, props) {
	...
	(0, _react.useEffect)(
		function() {
			var select = (0, _dotPropImmutableChain['default'])(box)
				.get('auth.spaces.'.concat(props.space, '.instance'))
				.value();
...
var useSpaceOpenRequestEffect = function useSpaceOpenRequestEffect(box, props) {
	...
	(0, _react.useEffect)(
		function() {
			var selector = (0, _dotPropImmutableChain['default'])(box)
				.get('box.auth.spaces'.concat(props.space, '.instance'))
				.value();
...
var useStorageRemoveRequestEffect = function useStorageRemoveRequestEffect(
	box,
	props
) {
...
var useStorageInsertRequestEffect = function useStorageInsertRequestEffect(
	box,
	props
) {
...
var useStorageDeleteRequestEffect = function useStorageDeleteRequestEffect(
	box,
	props
) {
...
var useThreadJoinEffect = function useThreadJoinEffect(box, props) {
	...
	(0, _react.useEffect)(
		function() {
			var select = (0, _dotPropImmutableChain['default'])(box)
				.get('auth.threads.'.concat(props.threadName))
				.value();
...
var useThreadReadyEffect = function useThreadReadyEffect(box, props) {
	...
	(0, _react.useEffect)(
		function() {
			var select = (0, _dotPropImmutableChain['default'])(box)
				.get('auth.threads.'.concat(props.threadName, '.instance'))
				.value();
			if (!isReady && select) setIsReady(true);
		},
		[box.auth.threads]
...
var useThreadPostDeleteRequestEffect = function useThreadPostDeleteRequestEffect(
	box,
	props
) {
	...
	(0, _react.useEffect)(
		function() {
			var selector = (0, _dotPropImmutableChain['default'])(box)
				.get('box.auth.threads'.concat(props.threadName))
				.value();
...
var useThreadListenEffect = function useThreadListenEffect(box, props) {
	...
	var _useState55 = (0, _react.useState)(
			props.threadName || props.threadAddress
		),
